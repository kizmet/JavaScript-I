...
// let info = inventory.filter(car => car.id == 33);
// console.log(info[0]);
...
// let carModels = inventory.sort(car => car.car_model);
...
// let BMWAndAudi = [];
// console.log();
let cFilter = inventory.filter(car => car.car_make =='BMW' || car.car_make == 'Audi');
console.log(JSON.stringify(cFilter));
