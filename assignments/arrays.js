...
function printInfo() {
	var result = "Car ${this.car_year} ${this.car_make} ${this.car_model}";
	console.log(result);
}
let car = idInfo(33);
car.prototype.printInfo = function(object) {
	var result = "Car ${object.car_year} ${object.car_make} ${object.car_model}";
	return result;
};
